        ...
        while (idx < valuesList.size()) {
            switch (operationsList[idx]) {
                case Operation::putOpr: {
                    ...
                    UpsertContext context{ fasterKeys[idx], fasterKeys[idx] };
                ...
                case Operation::getOpr: {
                    ...
                    std::cout << "ok "<< (Status::Ok==result) << " get " <<   " gotten val: " << context.output  << " key: " << fasterKeys[idx] << " my key"  << keysList[idx] <<  std::endl;
                    /*
                    if(result == Status::Ok)

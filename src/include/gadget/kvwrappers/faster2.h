   ...
   */
    ...
    void uintTest() {
        ...
        { auto callback = [](IAsyncContext *ctxt, Status result) {
            ...
            assert(context.output_letters[0] == 'v'); // first letter
            assert(context.output_letters[1] == 'v'); // last letter
        ...
        //get
        {
            ...
            assert(Status::Ok==result);
            assert(context.output_length == VALUESIZE);
            assert(context.output_letters[0] == 'p');
            assert(context.output_letters[1] == 'p');
        }
        // rmw
        {
            auto callback = [](IAsyncContext* ctxt, Status result) {
        ...
        //get
        {
            ...
            assert(Status::Ok==result);
            assert(context.output_length == 2 * VALUESIZE);
            assert(context.output_letters[0] == 'p');
            assert(context.output_letters[1] == 'p');
        }
        // rmw
        ...
        // get
        {
            ...
            assert(Status::Ok==result);
            assert(context.output_length == 3 * VALUESIZE);
            assert(context.output_letters[0] == 'p');
            //std::cout<< "last latter: " << context.output_letters[1] << std::endl;
            assert(context.output_letters[1] == 'p');
        }
        // rmw
        { auto callback = [](IAsyncContext* ctxt, Status result) {
        ...
        // get
        {
            ...
            assert(Status::Ok==result);
            assert(context.output_length == 6 * VALUESIZE);
            assert(context.output_letters[0] == 'p');
            //std::cout<< "last latter: " << context.output_letters[1] << std::endl;
            assert(context.output_letters[1] == 'p');
        }

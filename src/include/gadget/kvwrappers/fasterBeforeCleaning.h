...
/// This benchmark stores an 8-byte value in the key-value store.
    ...
    public:
        ...
        inline void RmwInitial(Value& value) {
            ...
            value.length_ = 2048;
            std::memset(value.buffer(), 'f', VALUESIZE);
        ...
        inline void RmwCopy(const Value& old_value, Value& value) {
            ...
            std::memset(value.buffer()+VALUESIZE, 'f', VALUESIZE );
        }
        inline bool RmwAtomic(Value& value) {
    ...
    public:
        ...
        inline void Put(Value& value) {
            ...
            std::memset(value.buffer(), 'k', length_);
        }
        inline bool PutAtomic(Value& value) {
            ...
            value.length_ = length_;
            std::memset(value.buffer(), 'p', length_);
            return true;
        }
    ...
    public:
        ...
        inline void GetAtomic(const Value& value) {
            ...
            std::cout << "value.length_ " << value.length_ << std::endl;

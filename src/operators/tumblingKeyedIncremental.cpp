...
#include "include/gadget/operator/operators/tumblingKeyedIncremental.h"
    ...
    TumblingKeyedIncremental::TumblingKeyedIncremental(std::shared_ptr<OperatorParameters> params){
        keyedOperator_ = true ;
...
void TumblingKeyedIncremental::assignWindows(const std::shared_ptr<Event> &event, std::vector<uint64_t> &windowStartTimes){

...
SlidingKeyedHolistic::SlidingKeyedHolistic(std::shared_ptr<OperatorParameters> params) {
        keyedOperator_ = true;
    ...
    void SlidingKeyedHolistic::assignWindows(const std::shared_ptr<Event> &event, std::vector<uint64_t> &windowStartTimes) {

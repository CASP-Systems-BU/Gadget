...
class tumblingAllHolistic: public ::testing::Test {
public:
    tumblingAllHolistic( ) {
...
TEST_F(tumblingAllHolistic, tumblingAllHolisticNumOpr) {
...
// scan ---> 4
// next ---> 5
TEST_F(tumblingAllHolistic, tumblingAllHolisticOprSequence) {
    std::vector<std::shared_ptr<Operation>> genOperations;
    // time unit 1
    genOperations.clear();
    opr->runOperator(genOperations);
    ...
    EXPECT_EQ( static_cast<int>(genOperations[2]->oprType), 3); //  merge  operation
...
TEST_F(tumblingAllHolistic, latetumblingAllHolisticOprSequence) {
    ...
    opr->runOperator(genOperations);
    EXPECT_EQ(genOperations.size(), 2);
    EXPECT_EQ( static_cast<int>(genOperations[0]->oprType), 0); //  merge  operation

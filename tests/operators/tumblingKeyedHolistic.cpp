...
class tumblingKeyedHolistic: public ::testing::Test {
public:
    tumblingKeyedHolistic( ) {
...
TEST_F(tumblingKeyedHolistic, tumblingKeyedHolisticNumOpr) {
    ...
    genOperations.clear();
    opr->runOperator(genOperations);
    EXPECT_EQ(genOperations.size(), 5);
...
// scan ---> 4
// next ---> 5
TEST_F(tumblingKeyedHolistic, tumblingKeyedHolisticOprSequence) {
    std::vector<std::shared_ptr<Operation>> genOperations;
    // time unit 1
    genOperations.clear();
    opr->runOperator(genOperations);
    ...
    // check the sequence of generated operations
    EXPECT_EQ( static_cast<int>(genOperations[0]->oprType), 2); //  merge  operation
    EXPECT_EQ( static_cast<int>(genOperations[1]->oprType),  0); //  merge  operation
    EXPECT_EQ( static_cast<int>(genOperations[2]->oprType), 3); //  delete  operation
    EXPECT_EQ( static_cast<int>(genOperations[3]->oprType),  0); //  merge  operation
    EXPECT_EQ( static_cast<int>(genOperations[4]->oprType), 3); //  delete  operation
...
TEST_F(tumblingKeyedHolistic, latetumblingKeyedHolisticOprSequence) {
    ...
    EXPECT_EQ(genOperations.size(), 5);
    // check the sequence of generated operations
    EXPECT_EQ( static_cast<int>(genOperations[0]->oprType), 2); //  merge  operationEXPECT_EQ( static_cast<int>(genOperations[1]->oprType),  0); //  merge  operation
    EXPECT_EQ( static_cast<int>(genOperations[1]->oprType), 0); //  get  operation
    EXPECT_EQ( static_cast<int>(genOperations[2]->oprType), 3); //  delete  operation
    EXPECT_EQ( static_cast<int>(genOperations[3]->oprType), 0); //  get  operation
    EXPECT_EQ( static_cast<int>(genOperations[4]->oprType), 3); //  delete  operation

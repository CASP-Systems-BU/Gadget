//
// Created by Showan Asyabi on 6/5/21.
//
...
class joinSliding: public ::testing::Test {
public:
    joinSliding( ) {
    ...
    void SetUp( ) {
        ...
        operatorParams->slidingLength = 4;
        ...
        operatorParams->operatorType = Operator::OperatorJoinSliding ;
...
TEST_F(joinSliding, joinSlidingNumOpr) {
    ...
    genOperations.clear();
    opr->runOperator(genOperations);
    EXPECT_EQ(genOperations.size(), 12);
...
// scan ---> 4
// next ---> 5
TEST_F(joinSliding, joinSlidingOprSequence) {
    std::vector<std::shared_ptr<Operation>> genOperations;
    // time unit 1
    genOperations.clear();
    opr->runOperator(genOperations);
    ...
    EXPECT_EQ( static_cast<int>(genOperations[1]->oprType), 2); //  merge  operation
    EXPECT_EQ( static_cast<int>(genOperations[2]->oprType), 2); //  merge  operation
    EXPECT_EQ( static_cast<int>(genOperations[3]->oprType), 2); //  merge  operation
    ...
    EXPECT_EQ( genOperations[6]->key, "0000000002");
    EXPECT_EQ( genOperations[7]->key, "0000000002");
    EXPECT_EQ( genOperations[8]->key, "0000000003");
    EXPECT_EQ( genOperations[9]->key, "0000000003");
    ...
    EXPECT_EQ( static_cast<int>(genOperations[8]->oprType), 0); //  get  operation
    EXPECT_EQ( static_cast<int>(genOperations[9]->oprType), 3); //  delete  operation
    EXPECT_EQ( static_cast<int>(genOperations[10]->oprType), 0); //  get  operation
    EXPECT_EQ( static_cast<int>(genOperations[11]->oprType), 3); //  delete  operation
    

    // check the keys generated operations
    EXPECT_EQ( genOperations[0]->key, "0000000008");
    EXPECT_EQ( genOperations[1]->key, "0000000009");
    EXPECT_EQ( genOperations[2]->key, "0000000004");
    EXPECT_EQ( genOperations[3]->key, "0000000004");
    EXPECT_EQ( genOperations[4]->key, "0000000005");
    EXPECT_EQ( genOperations[5]->key, "0000000005");
    EXPECT_EQ( genOperations[6]->key, "0000000006");
    EXPECT_EQ( genOperations[7]->key, "0000000006");
    EXPECT_EQ( genOperations[8]->key, "0000000007");
    EXPECT_EQ( genOperations[9]->key, "0000000007");
    EXPECT_EQ( genOperations[10]->key, "0000000008");
    EXPECT_EQ( genOperations[11]->key, "0000000008");
    ...
    // check the keys generated operations
    EXPECT_EQ( genOperations[0]->key, "0000000010");
    ...
    EXPECT_EQ( static_cast<int>(genOperations[0]->oprType), 2); //  merge  operation
    // check the keys generated operations
    EXPECT_EQ( genOperations[0]->key, "0000000011");
...
TEST_F(joinSliding, latejoinSlidingOprSequence) {

...
class slidingKeyedIncremental: public ::testing::Test {
public:
    slidingKeyedIncremental( ) {
...
TEST_F(slidingKeyedIncremental, slidingKeyedNumOpr) {
...
// scan ---> 4
// next ---> 5
TEST_F(slidingKeyedIncremental, slidingKeyedOprSequence) {
    std::vector<std::shared_ptr<Operation>> genOperations;
    genOperations.clear();
    opr->runOperator(genOperations);
    ...
    EXPECT_EQ( static_cast<int>(genOperations[5]->oprType), 3); // delete operation
    EXPECT_EQ( static_cast<int>(genOperations[6]->oprType), 0); // get operation
    EXPECT_EQ( static_cast<int>(genOperations[7]->oprType), 3); // put operation
    EXPECT_EQ( static_cast<int>(genOperations[8]->oprType), 0); // get operation
    EXPECT_EQ( static_cast<int>(genOperations[9]->oprType), 3); // put operation
    ...
    EXPECT_EQ( genOperations[2]->key, "0000000008");
    EXPECT_EQ( genOperations[3]->key, "0000000008");
    EXPECT_EQ( genOperations[4]->key, "0000000004");
    EXPECT_EQ( genOperations[5]->key, "0000000004");
    EXPECT_EQ( genOperations[6]->key, "0000000005");
    EXPECT_EQ( genOperations[7]->key, "0000000005");
    EXPECT_EQ( genOperations[8]->key, "0000000006");
    EXPECT_EQ( genOperations[9]->key, "0000000006");
    EXPECT_EQ( genOperations[10]->key, "0000000007");
    EXPECT_EQ( genOperations[11]->key, "0000000007");
    ...
    EXPECT_EQ( genOperations[1]->key, "0000000010");
...
TEST_F(slidingKeyedIncremental, lateslidingKeyedOprSequence) {
    ...
    EXPECT_EQ( genOperations[0]->key, "0000000009");
    EXPECT_EQ( genOperations[1]->key, "0000000009");
    EXPECT_EQ( genOperations[2]->key, "0000000007");
    EXPECT_EQ( genOperations[3]->key, "0000000007");
    ...
    EXPECT_EQ( static_cast<int>(genOperations[3]->oprType), 3); // delete operation
    EXPECT_EQ( static_cast<int>(genOperations[4]->oprType), 0); // get operation
    EXPECT_EQ( static_cast<int>(genOperations[5]->oprType), 3); // put operation
    EXPECT_EQ( static_cast<int>(genOperations[6]->oprType), 0); // get operation
    EXPECT_EQ( static_cast<int>(genOperations[7]->oprType), 3); // put operation
    EXPECT_EQ( static_cast<int>(genOperations[8]->oprType), 0); // get operation
    EXPECT_EQ( static_cast<int>(genOperations[9]->oprType), 3); // delete operation

...
class tumblingAllIncremental: public ::testing::Test {
public:
    tumblingAllIncremental( ) {
...
TEST_F(tumblingAllIncremental, tumblingAllNumOpr) {
...
// scan ---> 4
// next ---> 5
TEST_F(tumblingAllIncremental, tumblingAllOprSequence) {
    std::vector<std::shared_ptr<Operation>> genOperations;
...
TEST_F(tumblingAllIncremental, lateTumblingAllOprSequence) {
    ...
    EXPECT_EQ( static_cast<int>(genOperations[1]->oprType), 1); // put operation
    EXPECT_EQ( static_cast<int>(genOperations[2]->oprType), 0); // get operation
    EXPECT_EQ( static_cast<int>(genOperations[3]->oprType), 3); // delete operation - delete the first window
    // check the keys generated operations
    EXPECT_EQ( genOperations[0]->key, "0000000002");
    EXPECT_EQ( genOperations[1]->key, "0000000002");
    EXPECT_EQ( genOperations[2]->key, "0000000001");
    ...
    // check the sequence of generated operations
    EXPECT_EQ( static_cast<int>(genOperations[0]->oprType), 0); // get operation
    EXPECT_EQ( static_cast<int>(genOperations[1]->oprType), 3); // delete operation - delete the second window
    // check the keys generated operations
    EXPECT_EQ( genOperations[0]->key, "0000000002");
    EXPECT_EQ( genOperations[1]->key, "0000000002");
    ...
    EXPECT_EQ( genOperations[0]->key, "0000000004");
    EXPECT_EQ( genOperations[1]->key, "0000000004");
    EXPECT_EQ( genOperations[2]->key, "0000000003"); //  out of order event
    EXPECT_EQ( genOperations[3]->key, "0000000003"); //  out of order event
    ...
    EXPECT_EQ( static_cast<int>(genOperations[1]->oprType), 1); // put operation
    EXPECT_EQ( static_cast<int>(genOperations[2]->oprType), 0); // get operation
    EXPECT_EQ( static_cast<int>(genOperations[3]->oprType), 3); //delete the third window
    // check the keys generated operations
    EXPECT_EQ( genOperations[0]->key, "0000000004");
    EXPECT_EQ( genOperations[1]->key, "0000000004");
    EXPECT_EQ( genOperations[3]->key, "0000000003");

...
class slidingAllHolistic: public ::testing::Test {
public:
    slidingAllHolistic( ) {
...
TEST_F(slidingAllHolistic, slidingAllNumOpr) {
...
// scan ---> 4
// next ---> 5
TEST_F(slidingAllHolistic, slidingAllOprSequence) {
    std::vector<std::shared_ptr<Operation>> genOperations;
    genOperations.clear();
    opr->runOperator(genOperations);
...
TEST_F(slidingAllHolistic, lateslidingAllOprSequence) {

...
class contAggr: public ::testing::Test {
public:
    contAggr( ) {
    ...
    void SetUp( ) {
       ...
       // make the value size distribution- the  size of values  that are inserted into the state store (i.e., KV store)
...
TEST_F(contAggr, contAggrNumOpr) {
    std::vector<std::shared_ptr<Operation>> genOperations;
    //get the first batch of state accesses
    genOperations.clear();
   ...
   // get the second batch of events for unit time 2 (there is no event for this time unit)
    ...
    genOperations.clear();
    opr->runOperator(genOperations);
    EXPECT_EQ(genOperations.size(), 4); // two  opr for event 8.3 and two opr for event 6.8 (out of order)
    ...
    // no event left - call returns no new operation
    genOperations.clear();
    opr->runOperator(genOperations);
    EXPECT_EQ(genOperations.size(), 0);
...
// scan ---> 4
// next ---> 5
TEST_F(contAggr, contAggrOprSequence) {
    std::vector<std::shared_ptr<Operation>> genOperations;
    ...
    // check the keys generated operations
    EXPECT_EQ( genOperations[0]->key, "0000000002"); // get operation
    EXPECT_EQ( genOperations[1]->key, "0000000002"); // put operation
    EXPECT_EQ( genOperations[2]->key, "0000000002"); // get operation
    EXPECT_EQ( genOperations[3]->key, "0000000002"); // put operation
    EXPECT_EQ( genOperations[4]->key, "0000000001"); // get operation
    EXPECT_EQ( genOperations[5]->key, "0000000001"); // put operation
    ...
    // check the keys generated operations
    EXPECT_EQ( genOperations[0]->key, "0000000003"); // get operation
    EXPECT_EQ( genOperations[1]->key, "0000000003"); // put operation
    ...
    // check the keys generated operations
    EXPECT_EQ( genOperations[0]->key, "0000000004"); // get operation
    EXPECT_EQ( genOperations[1]->key, "0000000004"); // put operation
    EXPECT_EQ( genOperations[2]->key, "0000000003"); // get operation
    EXPECT_EQ( genOperations[3]->key, "0000000003"); // put operation
    ...
    // check the keys generated operations
    EXPECT_EQ( genOperations[0]->key, "0000000005"); // get operation
    EXPECT_EQ( genOperations[1]->key, "0000000005"); // put operation
    ...
    // check the keys generated operations
    EXPECT_EQ( genOperations[0]->key, "0000000001"); // get operation
    EXPECT_EQ( genOperations[1]->key, "0000000001"); // put operation
    EXPECT_EQ( genOperations[2]->key, "0000000001"); // get operation
    EXPECT_EQ( genOperations[3]->key, "0000000001"); // put operation
    ...
    // check the keys generated operations
    EXPECT_EQ( genOperations[0]->key, "0000000006"); // get operation
    EXPECT_EQ( genOperations[1]->key, "0000000006"); // put operation

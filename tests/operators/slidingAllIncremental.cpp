...
class slidingAllIncremental: public ::testing::Test {
public:
    slidingAllIncremental( ) {
...
TEST_F(slidingAllIncremental, slidingAllNumOpr) {
...
// scan ---> 4
// next ---> 5
TEST_F(slidingAllIncremental, slidingAllOprSequence) {
    std::vector<std::shared_ptr<Operation>> genOperations;
    genOperations.clear();
    opr->runOperator(genOperations);
...
TEST_F(slidingAllIncremental, lateslidingAllOprSequence) {
